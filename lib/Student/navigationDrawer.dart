...
class NavigationDrawerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final urlImage = 'assets/images/student.png';
              ...
              Column(
                ...
                children: [
                  Text(
                    name,
                    style: TextStyle(
                        fontSize: 15, color: Color.fromARGB(255, 3, 1, 1)),
                  ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Developed by',
                      style: TextStyle(
                          fontSize: 15.0, height: 2.0, color: Colors.black)),
                  Text('Sujyot Kothale                :   1913054',
                      style: TextStyle(
                          fontSize: 15.0, height: 2.0, color: Colors.black54)),
                  Text('Aayush Paturkar             :   1913040',
                      style: TextStyle(
                          fontSize: 15.0, height: 2.0, color: Colors.black54)),
                  Text('Priyanshu Mahukhaye   :   1913028',
                      style: TextStyle(
                          fontSize: 15.0, height: 2.0, color: Colors.black54)),
                  Text('Sarthak Khutafale          :   1913049',
                      style: TextStyle(
                          fontSize: 15.0, height: 2.0, color: Colors.black54)),
                  Text('Ayush Shahu                   :   1913050',
                      style: TextStyle(
                          fontSize: 15.0, height: 2.0, color: Colors.black54)),
                  SizedBox(
                    height: 30,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('-presenceattendance@gmail.com',
                      style: TextStyle(
                  ...
                  Text('-Helpline(Mon-Sun,10AM-7PM):8275014834',
                      style: TextStyle(
