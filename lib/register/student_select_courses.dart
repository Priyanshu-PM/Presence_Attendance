...
class Studentselectcourses extends StatefulWidget {
  final User user;
  final String inscode;
  final String username;
  final String pass;

  const Studentselectcourses(
      {Key? key,
      required this.user,
      ...
      : super(key: key);
  @override
  _StudentselectcoursesState createState() => _StudentselectcoursesState();
}

bool flag = false;

class _StudentselectcoursesState extends State<Studentselectcourses> {
